...
#define __GMP_CFLAGS "-O2 -fPIC -march=i686 -mtune=pentium4 -fno-gcse  -O2 -DSQLITE_HAVE_ISNAN -fno-math-errno -funsafe-math-optimizations -fno-signed-zeros -fno-trapping-math -ffinite-math-only -fno-rounding-math -fno-signaling-nans -ftree-vectorize -fomit-frame-pointer -funswitch-loops -fivopts -funsafe-loop-optimizations -fpredictive-commoning -ftracer -ftree-loop-im -frename-registers -fcx-limited-range -m32 -DNO_ASM"
