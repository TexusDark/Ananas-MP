...
class Server{
	...
	public function getServerName(){
		return $this->getConfigString("motd", "Ananas: PE Server");
	}
	...
	public function __construct(\ClassLoader $autoloader, \ThreadedLogger $logger, $filePath, $dataPath, $pluginPath){
		...
		echo "     _                                      __  __ ____   \n";
		echo "    / \   _ __   __ _ _ __   __ _ ___      |  \/  |  _ \  \n";
		echo "   / _ \ | '_ \ / _` | '_ \ / _` / __|_____| |\/| | |_) | \n";
		echo "  / ___ \| | | | (_| | | | | (_| \__ \_____| |  | |  __/  \n";
		echo " /_/   \_\_| |_|\__,_|_| |_|\__,_|___/     |_|  |_|_|     \n";
		echo " \n";
		
		$this->logger->info(TextFormat::YELLOW . TextFormat::BOLD . "Ananas-MP : Welcome !");
		
		$version = new VersionString($this->getPocketMineVersion());
		$this->logger->info("Loading ananas.yml...");
		if(!file_exists($this->dataPath . "ananas.yml")){
			$content = file_get_contents($this->filePath . "src/pocketmine/resources/ananas.yml");
			if($version->isDev()){
				$content = str_replace("preferred-channel: stable", "preferred-channel: beta", $content);
			}
			@file_put_contents($this->dataPath . "ananas.yml", $content);
		}
		$this->config = new Config($this->dataPath . "ananas.yml", Config::YAML, []);
