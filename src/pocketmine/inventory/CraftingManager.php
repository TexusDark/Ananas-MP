...
class CraftingManager{
	...
	public function __construct(){
		...
		$this->registerRecipe((new BigShapedRecipe(Item::get(Item::SPRUCE_DOOR, 0, 1),
			...
			"WW",
			"WW"
		))->setIngredient("W", Item::get(Item::WOODEN_PLANK, Planks::SPRUCE, 6)));

		$this->registerRecipe((new BigShapedRecipe(Item::get(Item::BIRCH_DOOR, 0, 1),
			"WW",
			"WW",
			"WW"
		))->setIngredient("W", Item::get(Item::WOODEN_PLANK, Planks::BIRCH, 6)));

		$this->registerRecipe((new BigShapedRecipe(Item::get(Item::JUNGLE_DOOR, 0, 1),
			"WW",
			"WW",
			"WW"
		))->setIngredient("W", Item::get(Item::WOODEN_PLANK, Planks::JUNGLE, 6)));

		$this->registerRecipe((new BigShapedRecipe(Item::get(Item::ACACIA_DOOR, 0, 1),
			"WW",
			"WW",
			"WW"
		))->setIngredient("W", Item::get(Item::WOODEN_PLANK, Planks::ACACIA, 6)));

		$this->registerRecipe((new BigShapedRecipe(Item::get(Item::DARK_OAK_DOOR, 0, 1),
			"WW",
			"WW",
			"WW"
		))->setIngredient("W", Item::get(Item::WOODEN_PLANK, Planks::DARK_OAK, 6)));
		...
		$this->registerRecipe((new BigShapedRecipe(Item::get(Item::FERMENTED_SPIDER_EYE, 0, 1),
			...
			"SEM",
			"   "
		))->setIngredient("S", Item::get(Item::SUGAR, 0, 1))->setIngredient("E", Item::get(Item::SPIDER_EYE, null, 1))->setIngredient("M", Item::get(Item::BROWN_MUSHROOM, null, 1)));
		
		$this->registerRecipe((new ShapedRecipe(Item::get(Item::BLAZE_POWDER, 0, 1),
			"R"
		))->setIngredient("R", Item::get(Item::BLAZE_ROD, 0, 1)));
		
		$this->registerRecipe((new BigShapedRecipe(Item::get(Item::MAGMA_CREAM, 0, 1),
			"   ",
			"SB ",
			"   "
		))->setIngredient("S", Item::get(Item::SLIME_BALL, 0, 1))->setIngredient("B", Item::get(Item::BLAZE_POWDER, 0, 1)));
		...
		$this->registerRecipe((new BigShapedRecipe(Item::get(Item::GLISTERING_MELON, 0, 1),
			...
			"GMG",
			"GGG"
		))->setIngredient("G", Item::get(Item::GOLDEN_NUGGET, 0, 8))->setIngredient("M", Item::get(Item::MELON, 0, 1)));
		
		$this->registerRecipe((new BigShapedRecipe(Item::get(Item::GOLDEN_CARROT, 0, 1),
			"GGG",
			"GCG",
			"GGG"
		))->setIngredient("G", Item::get(Item::GOLDEN_NUGGET, 0, 8))->setIngredient("C", Item::get(Item::CARROT, 0, 1)));
	}
	...
	protected function registerFurnace(){
		...
		$this->registerRecipe(new FurnaceRecipe(Item::get(Item::QUARTZ, 0, 1), Item::get(Item::NETHER_QUARTZ_ORE, 0, 1)));
