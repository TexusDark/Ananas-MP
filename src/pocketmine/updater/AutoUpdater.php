...
class AutoUpdater{
	...
	public function showConsoleUpdate(){
		...
		$logger->warning("----- Ananas-MP Auto Updater -----");
		$logger->warning("Your version of Ananas-MP is out of date. Version " . $newVersion->get(false) . " (build #" . $newVersion->getBuild() . ") was released on " . date("D M j h:i:s Y", $this->updateInfo["date"]));
